...
UI_WIZARD4_T(ui_wiz_filamentchange_insert, UI_ACTION_WIZARD_FILAMENTCHANGE_INSERT, UI_TEXT_WIZ_CH_FILAMENT4_ID, UI_TEXT_WIZ_CH_FILAMENT2_ID, UI_TEXT_WIZ_CH_FILAMENT3_ID, UI_TEXT_CLICK_DONE_ID)
#else
...
UI_WIZARD2_T(ui_wiz_filamentchange_insert, UI_ACTION_WIZARD_FILAMENTCHANGE_INSERT, UI_TEXT_WIZ_CH_FILAMENT4_ID, UI_TEXT_CLICK_DONE_ID)
#endif
UI_WIZARD2_T(ui_msg_filamentchange_not_heated, UI_ACTION_MESSAGE, UI_TEXT_NOTIFICATION_ID, UI_TEXT_EXTRUDER_COLD_ERROR_ID)
#endif
...
#endif
#if CASE_LIGHTS_PIN >= 0 || defined(OLP_LED)
